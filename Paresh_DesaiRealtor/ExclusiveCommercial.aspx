<%@ Page Title="" Language="C#" MasterPageFile="~/Property_New1.Master" AutoEventWireup="true" CodeBehind="ExclusiveCommercial.aspx.cs" Inherits="Property.ExclusiveCommercial" %>
...
<%@ Register TagName="ExclusiveCommercialControl" TagPrefix="uc" Src="~/Controls/ExclusiveCommercialControl.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="email_bg">
        <div class="Detail_Email">
            <uc:ExclusiveCommercialControl ID="ExclusiveCommercialControl" runat="server" />
        </div>
    </div>
