...
{
    public partial class ExclusiveCommercialControl : System.Web.UI.UserControl
    {
        #region PageLoad
        ...
        void GetImages(int DreamHouseId)
        {
            ...
            DataTable dt = clsobj.GetExclusiveCommercialForSlider(DreamHouseId);
            if (dt.Rows.Count > 0)
            {
        ...
        void GetDreamHouseDetail(int DreamHouseId)
        {
            ...
            DataTable dt = clsobj.GetExclusiveCommercialDetail(DreamHouseId);
            if (dt.Rows.Count > 0)
            {
