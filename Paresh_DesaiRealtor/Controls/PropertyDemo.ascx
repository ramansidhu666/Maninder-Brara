 ...
 <script>
     ...
     $(document).ready(function () {
         $("#shareBtn").click(function () {
             ...
             var URL = 'http://www.teambarara.com/PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
                                ...
                                <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px; float: left; height: 656px; overflow: hidden;">
                                    ...
                                    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 560px; overflow: hidden;">
                                        <asp:Repeater ID="rptImages" runat="server">
                                            <ItemTemplate>
                                                <div>
                                                    <img u="image" src='http://webservices.only4agents.com<%#Eval("MLSImage").ToString().Substring(25, Convert.ToInt32(Eval("MLSImage").ToString().Length - 25)) %>' alt="" />
                                                    <img u="thumb" src='http://webservices.only4agents.com<%#Eval("MLSImage").ToString().Substring(25, Convert.ToInt32(Eval("MLSImage").ToString().Length - 25)) %>' alt="" />
                                                </div>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </div>
