<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExclusiveResidentialControl.ascx.cs" Inherits="Property.Controls.ExclusiveResidentialControl" %>
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="roco_pro_info">
                            <h2 style="font-size:19px !important">
                                <asp:Label ID="lblname"  runat="server"></asp:Label>Team Barara</h2>
