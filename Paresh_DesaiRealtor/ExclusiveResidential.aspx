<%@ Page Title="" Language="C#" MasterPageFile="~/Property_New1.Master" AutoEventWireup="true" CodeBehind="ExclusiveResidential.aspx.cs" Inherits="Property.ExclusiveResidential" %>
...
<%@ Register TagName="ExclusiveResidentialControl" TagPrefix="uc" Src="~/Controls/ExclusiveResidentialControl.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="email_bg">
        <div class="Detail_Email">
            <uc:ExclusiveResidentialControl ID="ExclusiveResidentialControl" runat="server" />
        </div>
    </div>
