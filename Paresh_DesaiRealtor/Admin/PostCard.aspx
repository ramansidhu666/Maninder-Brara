                ...
                <div class="form-horizontal row-fluid">
                    ...
                    <div class="newsltr_bg" id="backside_page" style="display: none">
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 60%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    <img src="/images/client_img.jpg" alt="" title="" style="width: 120px; height: 120px; border-radius: 66px; border: 2px solid white; margin: 3px 0;" />
                                    <h2 style="float: left; margin: 6px 0; text-align: center; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 20px; font-weight: bold;">Team Barara</h2>
                    <p style="float: left; text-align: center; margin: 2px 0; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">P: 647-588-0172</p>
                    <p style="float: left; text-align: center; width: 100%; margin: 2px 0; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">info@teambarara.com | www.teambarara.com</p>
                    <p style="float: left; text-align: center; width: 100%; color: white; margin: 2px 0; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">RE/MAX Champions Realty Inc., Brokerage </p>
                    <p style="float: left; text-align: center; width: 100%; color: white; margin: 2px 0; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">1098 Peter Robertson Blvd #25</p>
                                </div>
                            </div>
                            <div style="float: left; width: 100%; text-align: center;">
                                <img src="/PostCardImages/futer_border.png" alt="" title="" style="width: 100%;" />
                        ...
                        <div id="feature_Front" style="float: left; width: 99%; background-color: #FFF; display: none; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0;">
                                <div style="float: left; width: 35%;">
                                    <img src="../images/client_img.jpg" alt="" title="" style="width: 95%;" />
                                </div>
                                <div style="float: left; width: 65%;">
                                    <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 12px;">
                                        <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Team Barara (Sales Representative)</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 647-588-0172</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: info@teambarara.com</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: http://www.teambarara.com</p>
                    ...
                    <div class="newsltr_bg" id="feature_Back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Team Barara(Sales Representative)</h2>
                                ...
                                <div style="float: left; width: 97%; margin: 8px 0; background-color: #1c1b1d; padding: 6px;">
                                    ...
                                    <div style="float: left; width: 65%;">
                                        <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 6px;">
                                            <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Team Barara</h2>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 647-588-0172</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: info@teambarara.com</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.teambarara.com</p>
                                            <div style="float: left; width: 97%; background-color: #101010; padding: 8px; margin: 6px 0;">
                                                <img src="/PostCardImages/feature_futer_logo.png" alt="" title="">
                                            </div>
                                        </div>
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Team Barara</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">Kingsway Real Estate Brokerage</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div style="float: left; width: 100%;">
                                    ...
                                    <div style="float: left; width: 65%;">
                                        <div style="float: left; padding: 6px;">
                                            <h2 style="float: left; width: 100%; color: #b80a05; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0; border-bottom: 1px solid;">Team Barara</h2>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 647-588-0172</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: info@teambarara.com</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.teambarara.com</p>
