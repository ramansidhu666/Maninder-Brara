    ...
    public class cls_Property
    {
        ...
        public DataTable GetFeaturedProperties()
        {
            ...
            try
            {
                ...
                string str = "GetResidentialProperties";
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                dt.TableName = "tbl_Featured";
            }
        ...
        #region Exclusive Residential Functionality
        ...
        public int InsertExclusiveCommercial(string Title, string filename, string Description, string Address, string Price, string Status, string Type, string Bed, string Bath, string Tax, string Mls, string Area)
        {
            int result = 0;
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "usp_InsertExclusiveListingCommercial";
                cmd.Parameters.AddWithValue("@Title", Title);
                cmd.Parameters.AddWithValue("@ImageUrl", filename);
                cmd.Parameters.AddWithValue("@Description", Description);
                cmd.Parameters.AddWithValue("@Address", Address);
        ...
        #region Exclusive Commercial Functionality
        public int InsertExclusiveImageCommercial(int DreamHouseId, string filename)
        {
            int result = 0;
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "Insert into [ExclusiveListingImagesCommercial](DreamHouseId,ImageUrl) values(@DreamHouseId,@ImageUrl)";
                cmd.Parameters.AddWithValue("@DreamHouseId", DreamHouseId);
                cmd.Parameters.AddWithValue("@ImageUrl", filename);
        ...
        public DataTable GetExclusiveCommercialForSlider(int DreamHouseId)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = "select * from ExclusiveListingImagesCommercial where DreamHouseId=" + DreamHouseId;
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
        ...
        public int DeleteExclusiveCommercial(int id)
        {
            int result = 0;
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "delete from ExclusiveListingCommercial where id=@id;";
                cmd.Parameters.AddWithValue("@id", id);
                cmd.Connection = conn;
                if (conn.State == ConnectionState.Closed)
                {
        ...
        public DataTable GetExclusiveCommercialDetail(int DreamHouseId)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = "select * from ExclusiveListingCommercial where Id=" + DreamHouseId;
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
        ...
        public DataTable GetExclusiveListingCommercial()
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = "usp_GetAllExclusiveListingCommercial";
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
